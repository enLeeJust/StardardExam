...
- (void)initControlBtn {
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 80, WIDTH/2, 80)];
...
//    [cancelBtn setTitle:@"Cancel" forState:UIControlStateNormal];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - WIDTH/2, self.view.frame.size.height - 80.0f, WIDTH/2, 80)];
