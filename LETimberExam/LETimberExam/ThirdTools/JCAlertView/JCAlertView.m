...
#define JCAlertViewWidth 280           //弹出框的宽
#define JCAlertViewHeight 174          //弹出框的高
...
- (void)setButton:(UIButton *)btn BackgroundWithButonType:(JCAlertViewButtonType)buttonType{
    ...
    switch (buttonType) {
        case JCAlertViewButtonTypeDefault:
            normalImage = [UIImage imageNamed:@"ic_alert"];
            highImage = [UIImage imageNamed:@"ic_alert"];
...
//            highImage = [UIImage imageNamed:@"JCAlertView.bundle/warn_high"];
            normalImage = [UIImage imageNamed:@"ic_login_btn_bg"];
            highImage = [UIImage imageNamed:@"ic_login_btn_bg"];
